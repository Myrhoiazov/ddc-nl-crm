...
### `SKY-C304` — Слишком длинная функция (185) — В ПРОЦЕССЕ (11/185)
...
### `SKY-Q301` — Слишком высокая цикломатическая сложность (35) — В ПРОЦЕССЕ (19/35)
...
обработаны 9 (`InvoicesPage.tsx`, `OrganizationBrandsPage.tsx`,
